...
import '~layout/l-mobile/style.scss';
import '~layout/l-container/style.scss';

import '~common/scripts/common';

import '~blocks/icon';
import '~blocks/icon-box';
import '~blocks/icon-pulse';

import '~blocks/image';
import '~blocks/badge';
import '~blocks/rating';
import '~blocks/input-phone';
import '~blocks/map-box';
import '~blocks/text-block';

import '~blocks/button';
import '~blocks/button-menu';

import '~blocks/popup';
import '~blocks/popup-callback';
import '~blocks/popup-feedback';

import '~blocks/section';
import '~blocks/section-title';
import '~blocks/section-head';
...
import '~blocks/form-search';
import '~blocks/form-success';

import '~blocks/menu-app';
import '~blocks/product-panel';

import '~mobile/grid-catalog';
import '~mobile/header';
import '~mobile/footer';
import '~mobile/menu-sticky';
import '~mobile/slider-products';
import '~mobile/section-map';
import '~mobile/section-contact';
